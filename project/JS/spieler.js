...
document.addEventListener("DOMContentLoaded", () => {
  ...
  <div class="svg-container">
    ...
    document.getElementById("likeCheckbox").addEventListener("change", (e) => {
      console.log((JSON.parse(localStorage.getItem(`likedPlayer`)) ?? []).push({ spiele: player.spiele,
         bild: player.bild,name: player.name, position: player.position, liked: e.target.checked }));
